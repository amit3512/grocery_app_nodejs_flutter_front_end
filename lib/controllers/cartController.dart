...
import 'package:grocery_app/constants/controllers.dart';
...
class CartController extends GetxController {
  ...
  // void addProductToCart(ProductModel product, productDetailPrice) {
  void addProductToCart() {
    try {
      Get.snackbar("Item added", "product name was added to your cart");

      print("reach here in addProductToCart");
  ...
  // bool _isItemAlreadyAdded(ProductModel product) => ProductModel.value.cart
